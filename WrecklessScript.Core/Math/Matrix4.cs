...
namespace WrecklessScript.Core.Math
{
    ...
    public struct Matrix4
    {
        ...
        {
            Debug.Log("{0:0.00}  {1:0.00}  {2:0.00}  {3:0.00}", D00, D10, D20, D30);
            Debug.Log("{0:0.00}  {1:0.00}  {2:0.00}  {3:0.00}", D01, D11, D21, D31);
            Debug.Log("{0:0.00}  {1:0.00}  {2:0.00}  {3:0.00}", D02, D12, D22, D32);
            Debug.Log("{0:0.00}  {1:0.00}  {2:0.00}  {3:0.00}", D03, D13, D23, D33);
        }
    }
}
